...
(obj "signature" :at "parameters" "parameters" :at "result" "fn result")  ;;TODO
(obj "parameters" :union((listt "parameter decl")))
(obj "paramater decl" :at "name" "identifier" :at "type" "type")
(obj "fn result" :union ("parameters" "type"))  ;;TODO
;interface types
...
(obj "underlying type" :at "type" "type")  ; ~Type  ;; CHECK LATER
;map types
(obj "map type" :at "key type" "type" :at "element type" "type")
;channel types
...
;; Blocks
(obj "block" :at "statements" ("statement list"))
...
(obj "const spec" :at "names" "id list" :at "type" "type" :at "initializers" "expr list")  ; a, c, d int := 5, 6, 7
...
(obj "type param list" :union ((listt "type param decl")))  ;; CHECK TO DELETE
